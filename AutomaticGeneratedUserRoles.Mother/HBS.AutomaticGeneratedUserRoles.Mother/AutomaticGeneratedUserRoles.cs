...
public class AutomaticGeneratedUserRolesInitializationModule : Module
{
    ...
    public AutomaticGeneratedUserRolesInitializationModule()
        : base("AutomaticGeneratedUserRolesInitializationModule_Mother")
    {
    }
    ...
    private void UserSite_Insert_After(object sender, ObjectEventArgs e)
    {
        ...
        UserInfo User = UserInfoProvider.GetUserInfo(UserSite.UserID);
    ...
    private void Site_Insert_After(object sender, ObjectEventArgs e)
    {
        ...
        RoleInfo AuthenticatedUserRole = GetOrCreateRole(_AuthenticatedRole, _AuthenticatedRoleDisplayName, _AuthenticatedRoleDescription, Site.SiteID);
        RoleInfo NotAuthenticatedUserRole = GetOrCreateRole(_NotAuthenticatedRole, _NotAuthenticatedRoleDisplayName, _NotAuthenticatedRoleDescription, Site.SiteID);
        RoleInfo EveryoneUserRole = GetOrCreateRole(_EveryoneRole, _EveryoneRoleDisplayName, _EveryoneRoleDescription, Site.SiteID);
    }
